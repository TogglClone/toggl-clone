...
export default class Reviews extends Component {
  ...
  handleReviewPosition(position) {
    const animateLeftKeys = [
      ShiftLeftPosition0,
      ShiftLeftPosition1,
      ShiftLeftPosition2
    ]
    const animateRightKeys = [
      ShiftRightPosition0,
      ShiftRightPosition1,
      ShiftRightPosition2
    ]
          ...
          <ImageWormBody entered={this.state.animateCalled}>
            <Worm>
              <Crypto
                ...
                viewBox="0 0 45.8 69.6"
              >
                <path
                  d="M23.5 68.1V63a5.6 5.6 0 0 1 5.6-5.6h1a5.6 5.6 0 0 0 5.6-5.6 5.6 5.6 0 0 0-5.6-5.6h-13a5.6 5.6 0 0 1-5.6-5.6 5.6 5.6 0 0 1 5.6-5.6h21.5a5.6 5.6 0 0 0 5.6-5.6 5.6 5.6 0 0 0-5.6-5.6H7.1a5.6 5.6 0 0 1-5.6-5.6 5.6 5.6 0 0 1 5.6-5.6h10.8A5.6 5.6 0 0 0 23.5 7V1.8"
                  fill="none"
                  stroke="#ffacba"
            ...
            <ImageContainer entered={this.state.animateCalled}>
              ...
              <Tasha
                entered={this.state.animateCalledTasha}
                slide={this.state.animateSlideTasha}
                onClick={() => {
                  this.wiggle(),
                    this.updateReviewie(tasha),
                    this.handleReviewPosition(this.state.tashaPosition)
                }}
                image={tasha[0]}
              />
              <Brad
                entered={this.state.animateCalledBrad}
                slide={this.state.animateSlideBrad}
                onClick={() => {
                  this.wiggle(),
                    this.updateReviewie(brad),
                    this.handleReviewPosition(this.state.bradPosition)
                }}
                image={brad[0]}
              />
              <Annika
                entered={this.state.animateCalledAnnika}
                slide={this.state.animateSlideAnnika}
                onClick={() => {
                  this.wiggle(),
                    this.updateReviewie(annika),
                    this.handleReviewPosition(this.state.annikaPosition)
                }}
                image={annika[0]}
              />
            </ImageContainer>
